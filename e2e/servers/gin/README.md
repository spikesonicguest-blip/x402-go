...
import (
    ...
    x402 "github.com/spikesonicguest-blip/x402-go"
    x402http "github.com/spikesonicguest-blip/x402-go/http"
    ginmw "github.com/spikesonicguest-blip/x402-go/http/gin"
    evm "github.com/spikesonicguest-blip/x402-go/mechanisms/evm/exact/server"
    svm "github.com/spikesonicguest-blip/x402-go/mechanisms/svm/exact/server"
    "github.com/spikesonicguest-blip/x402-go/extensions/bazaar"
)
...
- `github.com/spikesonicguest-blip/x402-go` - Core x402
- `github.com/spikesonicguest-blip/x402-go/http` - HTTP integration
- `github.com/spikesonicguest-blip/x402-go/http/gin` - Gin middleware
- `github.com/spikesonicguest-blip/x402-go/mechanisms/evm` - EVM server
- `github.com/spikesonicguest-blip/x402-go/mechanisms/svm` - SVM server
- `github.com/spikesonicguest-blip/x402-go/extensions/bazaar` - Discovery extension
